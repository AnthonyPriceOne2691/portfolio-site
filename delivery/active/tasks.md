...
- [ ] T11. CI §8.3 + гейт мержа §8.5 (`merge_guard.sh`, `check_ci_status.sh`,
      pre-push, `main-guard`)
- [x] T12. `contour_doctor.py` — проверка A6, `DEAD 0`
- [x] T13. Приёмка §6, `STACK-ACCEPTANCE.md`, честные отметки weak/absent
- [ ] T14. Репозиторий на GitHub (**приватный**, решение 07.08) + первый зелёный
      прогон CI. Репозиторий создан и запушен; прогон ещё не состоялся — push,
      создающий дефолтную ветку, workflow не поднимает
