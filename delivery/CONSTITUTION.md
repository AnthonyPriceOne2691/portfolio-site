...
**Version:** 1.0
**Ratified:** 2026-08-04
**Canon stack:** delivery@1.84 · cqg@2.28 · okf@absent
...
<!-- 07.08: подтверждено ФАКТОМ зелёного прогона, как и требует §10.4 — #3–#5 на
     PR, #6 на main. Первые два прогона были красными по делу: `cache: pip` без
     python-манифеста и замкнутый круг `--require-ci` (разбор — в STATUS у
     `ci-oracles`). -->
